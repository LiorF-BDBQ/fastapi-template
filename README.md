...
[![codecov](https://codecov.io/gh/LiorF-BDBQ/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/LiorF-BDBQ/fastapi-template)
[![CI](https://github.com/LiorF-BDBQ/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/LiorF-BDBQ/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by LiorF-BDBQ

## Install

from source
```bash
git clone https://github.com/LiorF-BDBQ/fastapi-template fastapi_template
cd fastapi_template
make install
```
